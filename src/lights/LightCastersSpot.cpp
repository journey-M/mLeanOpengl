...
void LightCastersSpot::initShader() {
  lightingShader = new Shader(
      std::string(baseDir).append("res/lights/5.3.lighting_casters.vs").c_str(),
      std::string(baseDir).append("res/lights/5.3.lighting_casters.fs").c_str());
...
void LightCastersSpot::initVertex() {
  float vertices[] = {
...
void LightCastersSpot::initTexture() {
...
unsigned int LightCastersSpot::loadTexture(char const *path) {
...
void LightCastersSpot::proceessKeyEvent(int key) {
...
// -------------------------------------------------------
void LightCastersSpot::mouse_callback(double xposIn, double yposIn) {
...
// ----------------------------------------------------------------------
void LightCastersSpot::scroll_callback(double xoffset, double yoffset) {
